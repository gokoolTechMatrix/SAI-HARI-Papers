...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (email === "admin@gmail.com" && password === "admin123") {
        console.log("Login successful. Redirecting to /employee-full-suite");
  ...
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-gradient-to-b from-sky-100 via-white to-white">
      ...
      {/* Brand */}
      <header className="absolute left-6 top-6 flex items-center gap-2 text-slate-700">
        <img src="/saiharipapers.jpg" alt="Sai Hari ERP Logo" className="h-8 w-auto" />
        <span className="text-sm font-medium tracking-wide">Sai Hari Papers ERP System</span>
      </header>
